<%--
//================================================================================
//  FileName: frmSFITWorksCommentsByUnitList.aspx
//  Desc:
//
//  Called by
//
...
//================================================================================
//--%>
<%@ Page Language="C#" MasterPageFile="Share/ModuleFrameSetMasterPage.Master" AutoEventWireup="true" CodeBehind="frmSFITWorksCommentsByUnitList.aspx.cs" Inherits="Yaesoft.SFIT.Web.frmSFITWorksCommentsByUnitList" %>
...
<asp:Panel ID="panelSearch" runat="server" CssClass="TableSearch" DefaultButton="btnSearch">
    ...
    <div style="float: left;">
        ...
        <JWC:TextBoxEx ID="txtCatalogName" runat="server" Width="166px" />
    </div>
...
<!--数据显示区域-->
<JWC:DataGridView ID="dgfrmSFITWorksCommentsByUnitList" runat="server" CssClass="DataGrid"
    Width="98%" ShowFooter="true" AllowSorting="true" AllowPaging="true" AllowExport="false"
    MouseoverCssClass="DataGridHighLight" PageSize="15" OnBuildDataSource="dgfrmSFITWorksCommentsByUnitList_BuildDataSource">
