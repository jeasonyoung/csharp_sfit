<%--
//================================================================================
//  FileName: frmSFITCatalogByUnitList.aspx
//  Desc:
//
//  Called by
//
...
//================================================================================
//--%>
<%@ Page Language="C#" MasterPageFile="Share/ModuleFrameSetMasterPage.Master" AutoEventWireup="true" CodeBehind="frmSFITCatalogByUnitList.aspx.cs" Inherits="Yaesoft.SFIT.Web.frmSFITCatalogByUnitList" %>
...
<div class="TitleBar">
	...
	<div style="float:right;">
		<span style="float:left;">
			<JWC:ButtonEx ID="btnAdd" runat="server" ButtonType="Add" PickerPage="frmSFITCatalogByUnitEdit.aspx" PickerType="Modal" PickerWidth="800px" PickerHeight="600px" onclick="btnAdd_Click"/>
		</span>
...
<JWC:DataGridView ID="dgfrmSFITCatalogList" runat="server" CssClass="DataGrid" Width="98%" ShowFooter="true"
	...
	<Columns>
		...
		<JWC:MultiQueryStringFieldEx PopupWin="true" WinType="Modal" WinWidth="800px" WinHeight="600px"
			DataNavigateUrlFormatString="frmSFITCatalogByUnitEdit.aspx?CatalogID={0}" DataNavigateUrlField="CatalogID"
