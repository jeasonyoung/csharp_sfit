	...
	<JWC:DataGridView ID="dgfrmSysMgrSettingPersonalList" runat="server" CssClass="DataGrid" Width="98%" ShowFooter="true"
		...
		<Columns>
			...
			<JWC:MultiQueryStringFieldEx PopupWin="true" WinType="Modal" WinWidth="540px" WinHeight="210px"
				...
				HeaderText="所属系统参数" DataField="SettingSign" SortExpression="SettingSign" meta:resourcekey="Sys_SettingSign">
			...
			<JWC:BoundFieldEx DataField="SettingValue" HeaderText="参数值" SortExpression="SettingValue" meta:resourcekey="Sys_SettingValue">
				<HeaderStyle Width="35%" />
				<ItemStyle HorizontalAlign="Left" />
			</JWC:BoundFieldEx>
		</Columns>
