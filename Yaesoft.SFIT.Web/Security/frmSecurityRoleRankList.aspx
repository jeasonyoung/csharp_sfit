...
<asp:Content ID="contentWorkPlace" ContentPlaceHolderID="workPlace" runat="server">
	...
	<asp:Panel ID="panelSearch" runat="server" CssClass="TableSearch" DefaultButton="btnSearch">
		...
		<div style="float:left;">
			<JWC:LabelEx ID="lbRankName" runat="server" Style="float:left;" meta:resourcekey="Sec_RankName">岗位级别名称：</JWC:LabelEx>
	...
	<JWC:DataGridView ID="dgfrmSecurityRoleRankList" runat="server" CssClass="DataGrid" Width="98%" ShowFooter="true"
		...
		<Columns>
			...
			<JWC:BoundFieldEx DataField="RankNames" HeaderText="所有岗位级别" SortExpression="RankNames" meta:resourcekey="Sec_RankNames">
