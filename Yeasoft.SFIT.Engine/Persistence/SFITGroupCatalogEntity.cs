//================================================================================
// FileName: SFITGroupCatalogEntity.cs
// Desc:
// Called by
// Auth: 本代码由代码生成器自动生成。
// Date:
...
{
	///<summary>
	///SFITGroupCatalogEntity实体类。
	///</summary>
	internal class SFITGroupCatalogEntity: DbModuleEntity<SFITGroupCatalog>
	{
		#region 成员变量，构造函数。
		///<summary>
		///构造函数
		///</summary>
		public SFITGroupCatalogEntity()
		{
        ...
        {
            const string sql = "exec spSFITGroupCatalogListView '{0}'";
